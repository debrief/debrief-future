...
| 062 | Tech Debt | [Add missing FeatureKindEnum values for tool migration](specs/062-missing-feature-kind-enum-values/spec.md) — add 7 new kinds (SENSOR, TMA_SEGMENT, etc.) and Feature classes to LinkML schemas; blocks 30+ tool implementations | 5 | 2 | 5 | 12 | Medium | specified |
