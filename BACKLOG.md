...
| 144 | Feature | [Import legacy Debrief sample data into STAC catalog](docs/ideas/144-import-legacy-sample-data.md) — build DPF parser, import all REP/DPF/DSF files (~148 files) from legacy repo, commit demo STAC catalog for stakeholder engagement | 5 | 5 | 3 | 13 | High | approved |
