...
| 174 | Feature | [E08] Thumbnail capture and gallery preview — capture Leaflet map as PNG on Save, store as STAC thumbnail assets (800x600 + 200x150), add gallery preview pane to catalog browser, Playwright backfill script for existing plots (requires #129) | 5 | 4 | 3 | 12 | Medium | approved |
