...
| E08 | STAC Stack Browser Discovery UI | [Analyst-facing discovery interface: filter bar, list/map/timeline views, vessel taxonomy, colour schemes](docs/stac-browser-srd.md) | approved | ~~#125~~, ~~#126~~, ~~#127~~, #128, ~~#129~~, ~~#130~~, ~~#131~~, #132, #133, #134, ~~#136~~, #174 |
...
| 132 | Infrastructure | [[E08] Three-view synchronization and filter state](specs/132-three-view-sync/spec.md) — shared filter state coordinating filter bar + list + map + timeline; dynamic updates; zero-results handling (requires #127, #129, #130, #131) | 5 | 4 | 3 | 12 | High | specified |
...
| 133 | Feature | [[E08] Vessel taxonomy and hierarchical filtering](specs/133-vessel-taxonomy/spec.md) — hierarchical vessel classification tree, subtree filtering in filter bar dropdown (requires #125, #127) | 4 | 3 | 4 | 11 | Medium | specified |
| 134 | Feature | [[E08] Colour scheme engine with legend](specs/134-colour-scheme-engine/spec.md) — configurable colour dimension (age/vessel class/tag), shared legend for map and timeline views (requires #130, #131) | 3 | 4 | 4 | 11 | Low | specified |
...
| 128 | Feature | [[E08] Saved filter configurations](docs/ideas/128-saved-filter-configurations.md) — save/load/delete named filter sets as CQL2 JSON; historic filters dropdown (requires #127) | 2 | 2 | 5 | 9 | Low | specified |
| 144 | Feature | [Import legacy Debrief sample data into STAC catalog](specs/144-import-legacy-sample-data/spec.md) — build DPF parser, import all REP/DPF/DSF files (~148 files) from legacy repo, commit demo STAC catalog for stakeholder engagement | 5 | 5 | 3 | 13 | High | specified |
...
| 116 | Feature | [[E07] Sensor schema overhaul](docs/ideas/E07-sensor-data-pipeline.md#phase-1-sensor-schema-overhaul-116) [E07] — full SensorContact/SensorData redesign with display properties, array offset modes, measured positions; update 9 tool spec fixtures (requires #062) | 5 | 3 | 4 | 12 | High | implementing |
| 117 | Feature | [[E07] REP sensor import](docs/ideas/E07-sensor-data-pipeline.md#phase-2-rep-sensor-import-117) [E07] — SENSOR v1/v2/v3 and SENSORARC parsers in debrief-io (requires #116) | 4 | 3 | 4 | 11 | Medium | proposed |
| 118 | Feature | [[E07] Sensor rendering](docs/ideas/E07-sensor-data-pipeline.md#phase-3-sensor-rendering-118) [E07] — Leaflet custom layer for bearing lines, ambiguous bearings, sensor arcs, snail mode (requires #116, #117) | 5 | 5 | 3 | 13 | High | proposed |
