...
| 129 | Feature | [[E08] List view with spatial thumbnails](specs/129-list-view-thumbnails/spec.md) — scrollable exercise list with metadata summary, spatial thumbnail, flexible sorting, recent-work resumption (requires #125) | 4 | 4 | 3 | 11 | Medium | specified |
| 131 | Feature | [[E08] Timeline/Gantt view with temporal filtering](specs/131-timeline-gantt-view/spec.md) — temporal extent bars, time range adjustment as live temporal filter (requires #125) | 4 | 4 | 3 | 11 | Medium | specified |
...
| 125 | Infrastructure | [[E08] STAC Extension spec + mock data fixtures](specs/125-stac-extension-mock-data/spec.md) — define extension namespace, property names for vessel class/tags/author/tracks/nationalities; create 100 fixture item.json files; document mock data contract | 4 | 2 | 4 | 10 | Medium | specified |
