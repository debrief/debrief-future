...
| 188 | Feature | [[E10] NL → CQL2 prompt design + generation](specs/188-nl-cql2-prompt/spec.md) — system prompt with CQL2 schema + extracted enums + `array_filter` syntax; generator + headless harness; **ships a hand-authored fixture corpus** so CI and offline stakeholder demos run with zero live-LLM dependency (requires #185, #187) | 5 | 4 | 3 | 12 | High | proposed |
