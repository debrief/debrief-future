...
| 143 | Bug | [Fix openPlotViaStacTree timeout in CI E2E tests](docs/e2e-stac-tree-loading-plan.md) — `openPlotViaStacTree()` times out (~42s) in every CI run; 8 test suites skipped; STAC tree never populates in openvscode-server despite config being pre-seeded; see plan doc for 3 solution options | 5 | 1 | 3 | 9 | Medium | approved |
