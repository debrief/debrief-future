...
| 136 | Infrastructure | [[E08] STAC Collection summaries for Browser backend](docs/ideas/136-stac-collection-summaries.md) — promote Catalogs to Collections with auto-generated summaries (temporal range, spatial extent, extension field enumerations); enables efficient CQL2 filtering (requires #125) | 4 | 2 | 3 | 9 | Medium | approved |
