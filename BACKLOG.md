...
| 179 | Feature | [[E07] Sensor-aware track rendering in Layers panel](docs/ideas/179-sensor-aware-layers-rendering.md) [E07] — extend FeatureList to show `Positions`/`Sensors`/`Track Segments` grouping rows under tracks with embedded sensors; each named sensor expands to its contacts (requires #116) | 3 | 2 | 5 | 10 | Medium | proposed |
