...
| 187 | Infrastructure | [[E10] Build-time enum extraction](docs/ideas/E10-nl-assisted-catalog-discovery.md) — script to extract vessel class tree, nationalities, exercise names, tags, feature_tags from registry + catalog; compact JSON for LLM prompt (requires #180, #184) | 3 | 1 | 5 | 9 | Low | proposed |
...
| 119 | Feature | [[E07] Array offset calculations](docs/ideas/E07-sensor-data-pipeline.md#phase-4-array-offset-calculations-119) [E07] — PLAIN, WORM, MEASURED array centre modes (requires #116) | 4 | 3 | 3 | 10 | Medium | implementing |
