...
| 116 | Feature | [[E07] Sensor schema overhaul](docs/ideas/E07-sensor-data-pipeline.md#phase-1-sensor-schema-overhaul-116) [E07] — full SensorContact/SensorData redesign with display properties, array offset modes, measured positions; update 9 tool spec fixtures (requires #062) | 5 | 3 | 4 | 12 | High | proposed |
