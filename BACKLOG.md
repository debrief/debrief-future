...
| 187 | Infrastructure | [[E10] Build-time enum extraction](docs/ideas/E10-nl-assisted-catalog-discovery.md) — script to extract vessel class tree, nationalities, exercise names, tags, feature_tags from registry + catalog; compact JSON for LLM prompt (requires #180, #184) | 3 | 1 | 5 | 9 | Low | implementing |
| 188 | Feature | [[E10] NL → CQL2 prompt design + generation](docs/ideas/E10-nl-assisted-catalog-discovery.md) — system prompt with CQL2 schema + extracted enums + `array_filter` syntax; LLM outputs CQL2 filter + chips; headless test harness with typical analyst phrases (requires #185, #187) | 5 | 4 | 3 | 12 | High | proposed |
