...
| 022 | Feature | [Design time controller UI/UX for VS Code extension](docs/ideas/022-time-controller.md) (BLOCKED: requires temporal data storage) | 5 | 5 | 4 | 14 | Medium | approved |
