...
| 188 | Feature | [[E10] NL → CQL2 prompt design + generation](docs/ideas/E10-nl-assisted-catalog-discovery.md) — system prompt with CQL2 schema + extracted enums + `array_filter` syntax; LLM outputs CQL2 filter + chips; headless test harness with typical analyst phrases (requires #185, #187) | 5 | 4 | 3 | 12 | High | implementing |
| 189 | Feature | [[E10] LLM transport integration](docs/ideas/E10-nl-assisted-catalog-discovery.md) — wire NL input to LLM call; auth/transport TBD (MCP tool, local proxy, or other) (requires #188) | 4 | 2 | 3 | 9 | Medium | proposed |
| 190 | Feature | [[E10] Stakeholder demo UI](docs/ideas/E10-nl-assisted-catalog-discovery.md) — no-build-step HTML/React playground; filter bar with NL input + CQL2 chips + card grid; stakeholder-ready (requires #186, #189) | 5 | 5 | 3 | 13 | Medium | proposed |
...
| 119 | Feature | [[E07] Array offset calculations](docs/ideas/E07-sensor-data-pipeline.md#phase-4-array-offset-calculations-119) [E07] — PLAIN, WORM, MEASURED array centre modes (requires #116) | 4 | 3 | 3 | 10 | Medium | proposed |
