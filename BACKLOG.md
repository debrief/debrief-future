...
| 186 | Feature | [[E10] Filter bar platform chips](docs/ideas/E10-nl-assisted-catalog-discovery.md) — update FilterBar for compound platform-based chips (nationality + domain, vessel type); wire to `array_filter` CQL2 expressions (requires #185) | 4 | 4 | 3 | 11 | Medium | proposed |
...
| 189 | Feature | [[E10] Stakeholder demo UI](specs/189-stakeholder-demo-ui/spec.md) — no-build-step HTML/React playground; query bar + filter chips + card grid; consumes #188's generator and hand-authored fixture transport so demos run offline and deterministically (requires #186, #188) | 5 | 5 | 3 | 13 | Medium | implementing |
