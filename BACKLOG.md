...
| 120 | Feature | [[E07] Bearing and frequency residual analysis](docs/ideas/E07-sensor-data-pipeline.md#phase-5-bearing--frequency-residual-analysis-120) [E07] — Doublet infrastructure, stacked dots custom React component, Doppler calculations (requires #116, #119) | - | - | - | - | High | proposed |
| 121 | Feature | [[E07] TMA data model and solution generation](docs/ideas/E07-sensor-data-pipeline.md#phase-6-tma-data-model--solution-generation-121) [E07] — TMA schemas, Absolute/Relative segments, solution generation from sensor cuts (requires #116, #120) | - | - | - | - | High | proposed |
| 122 | Feature | [[E07] TMA interactive drag](docs/ideas/E07-sensor-data-pipeline.md#phase-7-tma-interactive-drag-122) [E07] — rotate/shear/stretch drag modes with live residual feedback (requires #121, #120) | - | - | - | - | High | proposed |
...
| 115 | Tech Debt | [Enforce schema-validated tool inputs and outputs (ADR-008)](docs/project_notes/decisions.md#adr-008-schema-validated-tool-inputs-and-outputs-2026-02-27) — all 12 calc tools bypass generated Pydantic models, working with raw `dict[str, Any]`; add `debrief_schemas` dependency, validate at service boundary, replace hardcoded enums with schema imports | 4 | 2 | 4 | 10 | High | approved |
