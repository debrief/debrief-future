...
| 101 | Bug | [Layers panel does not expand to fill vertical space](docs/ideas/101-layers-panel-vertical-space.md) — Layers section should flex-grow when Time Controller and Tools are collapsed; pure CSS fix | 3 | 2 | 5 | 10 | Low | approved |
| 100 | Tech Debt | [Unify feature pipeline: single FeatureCollection from stacService](docs/ideas/100-unify-feature-pipeline.md) — stacService.loadPlotData() should return one FeatureCollection instead of splitting into tracks/locations/otherFeatures; let React components classify by feature properties | 3 | 1 | 4 | 8 | Medium | approved |
