...
| 137 | Enhancement | [REP loader temporal metadata](specs/137-rep-temporal-metadata/spec.md) — compute `start_datetime`/`end_datetime` from track position timestamps during REP file loading; enables accurate Timeline/Gantt view and Duration filter | 4 | 2 | 4 | 10 | Low | specified |
