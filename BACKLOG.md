...
| 114 | Enhancement | Keyboard-only flip-card interaction — add Enter/Space to trigger card flip, focus management on back face, Tab order through edit controls; accessibility compliance for the flip-card paradigm introduced in #113 (requires #113) | 3 | 2 | 5 | 10 | Low | proposed |
