...
| 128 | Feature | [[E08] Saved filter configurations](specs/128-saved-filter-configurations/spec.md) — save/load/delete named filter sets as CQL2 JSON; historic filters dropdown (requires #127) | 2 | 2 | 5 | 9 | Low | specified |
