...
| 191 | Feature | [Add Properties Panel for editing STAC plot & catalog metadata](https://github.com/debrief/debrief-future/issues/447) — context-sensitive panel: 4th ActivityPanel section edits the open plot (staged via session-state, flushed on save); StacBrowser side panel edits item.json directly when no plot is open; schema-driven form from LinkML-generated JSON Schema (complementary to #135) | 4 | 3 | 3 | 10 | Medium | implementing |
