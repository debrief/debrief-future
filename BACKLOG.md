...
| 117 | Feature | [[E07] REP sensor import](specs/117-rep-sensor-import/spec.md) [E07] — SENSOR v1/v2/v3 and SENSORARC parsers in debrief-io (requires #116) | 4 | 3 | 4 | 11 | Medium | specified |
| 118 | Feature | [[E07] Sensor rendering](specs/118-sensor-rendering/spec.md) [E07] — Leaflet custom layer for bearing lines, ambiguous bearings, sensor arcs, snail mode (requires #116, #117) | 5 | 5 | 3 | 13 | High | specified |
