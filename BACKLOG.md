...
| 183 | Feature | [[E10] Save-time registry resolution](docs/ideas/E10-nl-assisted-catalog-discovery.md) — resolve each TRACK `platform_id` against registry tree at save; overlay analyst-set overrides; emit fully resolved `debrief:platforms` on item.json (requires #180, #181) | 5 | 3 | 4 | 12 | Medium | implementing |
