...
| 029 | Tech Debt | [Integrate session-state service into VS Code extension](docs/ideas/029-session-state-vscode-integration.md) (multi-document support) | 5 | 3 | 4 | 12 | High | approved |
