/**
 * Temporal track utility functions for the map webview.
 *
 * Ported from shared/components/src/MapView/temporal-utils.ts
 * to avoid React dependency in the vanilla JS webview.
 */
