/**
 * Type definitions for the Colour Scheme Engine (#134).
 *
 * Defines colour dimensions, palettes, legend models, and
 * the colour assignment output consumed by map and timeline views.
 */
...
// Re-export StacBrowserItem for convenience
