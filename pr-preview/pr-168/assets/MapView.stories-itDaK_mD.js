...
/>
\`\`\`
        `}}}};function ye(){const[r,n]=T.useState(new Set(["track-001","track-002","ref-001","ref-002"])),o=t=>{n(l=>{const a=new Set(l);return a.has(t)?a.delete(t):a.add(t),a})},d=["track-001","track-002","ref-001","ref-002"];return e.jsxs("div",{children:[e.jsxs("div",{style:{marginBottom:16},children:[e.jsx("strong",{children:"Toggle Visibility:"}),e.jsx("div",{style:{display:"flex",gap:8,marginTop:8,flexWrap:"wrap"},children:d.map(t=>e.jsxs("label",{style:{display:"flex",alignItems:"center",gap:4},children:[e.jsx("input",{type:"checkbox",checked:r.has(t),onChange:()=>o(t)}),t]},t))}),e.jsx("small",{style:{display:"block",marginTop:8},children:"Use the toolbar's fit-to-window button (bottom icon) to zoom to visible features only."})]}),e.jsx(i,{features:s,visibleIds:r,height:500})]})}const x={render:()=>e.jsx(ye,{}),parameters:{docs:{description:{story:"Toggle feature visibility and use the fit-to-window button to zoom to only the visible features."}}}},k={render:()=>e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16},children:[e.jsxs("div",{children:[e.jsx("div",{style:{marginBottom:8},children:e.jsx("strong",{children:"Top Left (default)"})}),e.jsx(i,{features:s,height:250,toolbarPosition:"topleft"})]}),e.jsxs("div",{children:[e.jsx("div",{style:{marginBottom:8},children:e.jsx("strong",{children:"Top Right"})}),e.jsx(i,{features:s,height:250,toolbarPosition:"topright"})]}),e.jsxs("div",{children:[e.jsx("div",{style:{marginBottom:8},children:e.jsx("strong",{children:"Bottom Left"})}),e.jsx(i,{features:s,height:250,toolbarPosition:"bottomleft"})]}),e.jsxs("div",{children:[e.jsx("div",{style:{marginBottom:8},children:e.jsx("strong",{children:"Bottom Right"})}),e.jsx(i,{features:s,height:250,toolbarPosition:"bottomright"})]})]}),parameters:{docs:{description:{story:"Toolbar can be positioned at any corner of the map using the toolbarPosition prop."}}}},w={args:{features:s,height:400,showToolbar:!1},parameters:{docs:{description:{story:"Map with custom toolbar hidden, showing the default Leaflet zoom control."}}}};var C,M,D;p.parameters={...p.parameters,docs:{...(C=p.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    features: sampleData,
    height: 500
  },
...
}`,...(D=(M=p.parameters)==null?void 0:M.docs)==null?void 0:D.source}}};var L,P,B;m.parameters={...m.parameters,docs:{...(L=m.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(ie=(ne=w.parameters)==null?void 0:ne.docs)==null?void 0:ie.source}}};const Le=["Default","WithSelection","LargeDataset","Empty","SingleTrack","CustomTileLayer","DarkTheme","MultiSelect","FiveLineExample","FitToVisible","ToolbarPositions","NoToolbar"];export{f as CustomTileLayer,y as DarkTheme,p as Default,h as Empty,x as FitToVisible,b as FiveLineExample,u as LargeDataset,S as MultiSelect,w as NoToolbar,g as SingleTrack,k as ToolbarPositions,m as WithSelection,Le as __namedExportsOrder,De as default};
