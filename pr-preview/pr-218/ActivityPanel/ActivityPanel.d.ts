 ...
 * ```
 */
export declare function ActivityPanel({ timeExtent, currentTime, playbackSpeed, displayMode, timeUiState, tools, hasToolInventory, hasToolSelection, features, selectedFeatureIds, hiddenIds, toolMatches, sourceFiles, resultFiles, resultsChanged, collapseState: externalCollapseState, onCollapseStateChange, onMessage, className, }: ActivityPanelProps): import("react/jsx-runtime").JSX.Element;
