 ...
 */
export declare function LayersToolbar({ selectedFeatureIds, features: _features, toolMatches, sourceFiles, resultFiles, toolsChanged, resultsChanged, filterState: externalFilterState, onDelete, onToggleVisibility, onRunTool, onRunAction, onFilterChange, onApplyToSelection, onFileAction, onDropdownOpened, labels: labelOverrides, className, }: LayersToolbarProps): import("react/jsx-runtime").JSX.Element;
