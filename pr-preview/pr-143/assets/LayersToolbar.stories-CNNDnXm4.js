import{j as o}from"./jsx-runtime-DF2Pcvd1.js";import{r as a}from"./index-B2-qRKKC.js";import{L as T,s as n,a as i,e as k,c as R,b as le,d as ne,f as ie}from"./tools-BSSWFcgX.js";import{T as ce,c as ue}from"./types-va9JkSoG.js";import{D as J}from"./FilterDropdown-DPuFK2uQ.js";import{T as X}from"./ThemeProvider-KrJW1DiK.js";import"./_commonjsHelpers-Cpj98o6Y.js";const de=["OWNSHIP","CONTACT","REFERENCE","SOLUTION"],y=["HMS Victory","USS Constitution","Contact Alpha","Contact Bravo","HMS Dreadnought","USS Enterprise","Contact Charlie","Contact Delta","HMS Illustrious","USS Nimitz"];function ee(e){const s=new Date("2024-06-15T08:00:00Z").getTime();return Array.from({length:e},(f,t)=>({type:"Feature",id:`track-${t.toString().padStart(3,"0")}`,geometry:{type:"LineString",coordinates:[[-5+t*.1,50],[-4+t*.1,51]]},properties:{kind:"TRACK",platform_id:`PLT-${t.toString().padStart(3,"0")}`,platform_name:`${y[t%y.length]} ${Math.floor(t/y.length)||""}`.trim(),track_type:de[t%4]??"CONTACT",start_time:new Date(s+t*36e5).toISOString(),end_time:new Date(s+(t+12)*36e5).toISOString(),positions:[]}}))}function te(e){const s=["Alpha Point","Bravo Marker","Charlie Station","Delta Buoy","Echo Reference","Foxtrot Position"];return Array.from({length:e},(f,t)=>({type:"Feature",id:`ref-${t.toString().padStart(3,"0")}`,geometry:{type:"Point",coordinates:[-3+t*.1,52+t*.05]},properties:{kind:"POINT",name:`${s[t%s.length]} ${Math.floor(t/s.length)||""}`.trim(),location_type:t%2===0?"WAYPOINT":"REFERENCE",valid_from:"2024-06-15T00:00:00Z",valid_until:"2024-06-15T23:59:59Z"}}))}const l=[...ee(20),...te(10)],pe=[...ee(3),...te(2)],ke={title:"Components/LayersToolbar",component:T,parameters:{layout:"padded",docs:{description:{component:"LayersToolbar provides 5 buttons: Delete, Visibility, Run (selection-scoped) and Filter, Associated Files (plot-scoped). Integrates with ToolMatchService for context-sensitive tool menus."}}},tags:["autodocs"],decorators:[e=>o.jsx(X,{children:o.jsx("div",{style:{maxWidth:500},children:o.jsx(e,{})})})]},u={args:{selectedFeatureIds:[],features:l,toolMatches:k,sourceFiles:i,resultFiles:n}},d={args:{selectedFeatureIds:["track-000","track-001","ref-000"],features:l,toolMatches:R(),sourceFiles:i,resultFiles:n,onDelete:e=>console.log("Delete:",e),onToggleVisibility:e=>console.log("Toggle visibility:",e),onRunTool:(e,s)=>console.log("Run tool:",e,s)}},p={args:{selectedFeatureIds:["track-000"],features:l,toolMatches:R(),toolsChanged:!0,sourceFiles:i,resultFiles:n}},m={args:{selectedFeatureIds:[],features:l,toolMatches:k,resultsChanged:!0,sourceFiles:i,resultFiles:n}},g={render:()=>{const[e,s]=a.useState({...J,textQuery:"HMS"});return o.jsx(T,{selectedFeatureIds:[],features:l,filterState:e,onFilterChange:s})}},F={args:{selectedFeatureIds:["track-000"],features:pe,toolMatches:k,sourceFiles:ne,resultFiles:le}};function me(){const[e,s]=a.useState(["track-000","track-001"]),[f,t]=a.useState(J),[se,C]=a.useState(!1),[oe,I]=a.useState(!1),b=a.useMemo(()=>new ce(ie),[]),v=a.useMemo(()=>{const r=[];for(const c of e){const M=l.find(ae=>ae.id===c);M&&r.push(M.properties.kind)}return ue(r)},[e]),re=a.useMemo(()=>b.getMatchResults(v),[b,v]);return o.jsxs("div",{children:[o.jsx(T,{selectedFeatureIds:e,features:l,toolMatches:re,toolsChanged:se,resultsChanged:oe,filterState:f,sourceFiles:i,resultFiles:n,onDelete:r=>console.log("Delete:",r),onToggleVisibility:r=>console.log("Visibility:",r),onRunTool:(r,c)=>console.log("Run:",r,c),onFilterChange:t,onApplyToSelection:r=>console.log("Apply:",r),onFileAction:(r,c)=>console.log("File action:",r.name,c),onDropdownOpened:r=>{r==="run"&&C(!1),r==="associated"&&I(!1)}}),o.jsxs("div",{style:{marginTop:12,fontSize:12,color:"#666"},children:[o.jsxs("p",{children:["Selected: ",e.join(", ")||"none"]}),o.jsx("button",{onClick:()=>s(["track-000","track-001"]),children:"Select 2 tracks"})," ",o.jsx("button",{onClick:()=>s(["track-000","ref-000"]),children:"Select track + point"})," ",o.jsx("button",{onClick:()=>s([]),children:"Clear selection"})," ",o.jsx("button",{onClick:()=>C(!0),children:"Trigger tools changed"})," ",o.jsx("button",{onClick:()=>I(!0),children:"Trigger results changed"})]})]})}const h={render:()=>o.jsx(me,{}),parameters:{docs:{description:{story:"Full interactive toolbar with live ToolMatchService integration. Use buttons below to change selection and trigger halo animations."}}}},S={render:()=>o.jsx(X,{theme:{variant:"dark"},children:o.jsx(T,{selectedFeatureIds:["track-000","track-001"],features:l,toolMatches:R(),sourceFiles:i,resultFiles:n,onDelete:e=>console.log("Delete:",e),onToggleVisibility:e=>console.log("Visibility:",e),onRunTool:(e,s)=>console.log("Run:",e,s)})}),parameters:{backgrounds:{default:"dark"}}};var x,D,E;u.parameters={...u.parameters,docs:{...(x=u.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    selectedFeatureIds: [],
...
}`,...(G=(q=S.parameters)==null?void 0:q.docs)==null?void 0:G.source}}};const Re=["NoSelection","WithSelection","WithToolsChanged","WithNewResults","WithActiveFilter","WithEmptyFiles","FullIntegration","DarkTheme"];export{S as DarkTheme,h as FullIntegration,u as NoSelection,g as WithActiveFilter,F as WithEmptyFiles,m as WithNewResults,d as WithSelection,p as WithToolsChanged,Re as __namedExportsOrder,ke as default};
