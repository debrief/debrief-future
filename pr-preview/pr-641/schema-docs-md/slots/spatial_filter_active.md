...
# Slot: spatial_filter_active 


_Whether the map viewport is used as a spatial filter_





URI: [debrief:slot/spatial_filter_active](https://debrief.info/schemas/slot/spatial_filter_active)
...
| ---  | ---  |
| self | debrief:spatial_filter_active |
| native | debrief:spatial_filter_active |
