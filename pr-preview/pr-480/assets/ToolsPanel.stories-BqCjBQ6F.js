import{j as e}from"./jsx-runtime-DF2Pcvd1.js";import{T as m}from"./ToolsPanel-BqlWd7h-.js";import{T as u}from"./ThemeProvider-mvcGjblv.js";import"./index-B2-qRKKC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./textfield-Dm39NdvL.js";import"./paramTypeResolver-Br4vj1cK.js";import"./types-CuJnRqfe.js";import"./ContextMenu-qheFrteX.js";const xe={title:"Components/ToolsPanel",component:m,parameters:{layout:"centered",docs:{description:{component:`
...
}`,...(S=(k=a.parameters)==null?void 0:k.docs)==null?void 0:S.source},description:{story:`Panel with all tools active.
Typically shown when selection matches all tool requirements.`,...(x=(w=a.parameters)==null?void 0:w.docs)==null?void 0:x.description}}};var C,P,L,I,A;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
...
}`,...(L=(P=r.parameters)==null?void 0:P.docs)==null?void 0:L.source},description:{story:`Panel with all tools inactive.
Typically shown when selection doesn't match any tool requirements.`,...(A=(I=r.parameters)==null?void 0:I.docs)==null?void 0:A.description}}};var O,W,_,E,j;n.parameters={...n.parameters,docs:{...(O=n.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    tools: []
  },
  parameters: {
...
"Calculate Range" has no parameters and executes immediately.`,...(ee=($=c.parameters)==null?void 0:$.docs)==null?void 0:ee.description}}};var te,oe,ae,re,ne;p.parameters={...p.parameters,docs:{...(te=p.parameters)==null?void 0:te.docs,source:{originalSource:`{
  args: {
    tools: [{
      id: 'style-track',
      name: 'Style Track',
...
}`,...(ae=(oe=p.parameters)==null?void 0:oe.docs)==null?void 0:ae.source},description:{story:`Tool with multiple parameters collects all values before execution.
Click "Style Track" to see the multi-parameter context menu.`,...(ne=(re=p.parameters)==null?void 0:re.docs)==null?void 0:ne.description}}};var se,ie,le,ce,pe;d.parameters={...d.parameters,docs:{...(se=d.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
    tools: [{
      id: 'toggle-labels',
      name: 'Toggle Labels',
...
Click "Toggle Labels" to see the boolean parameter context menu.`,...(pe=(ce=d.parameters)==null?void 0:ce.docs)==null?void 0:pe.description}}};const Ce=["Default","AllActive","AllInactive","EmptyState","LightTheme","DarkTheme","VSCodeTheme","WithParameterizedTool","WithMultiParameterTool","WithBooleanParameterTool"];export{a as AllActive,r as AllInactive,i as DarkTheme,o as Default,n as EmptyState,s as LightTheme,l as VSCodeTheme,d as WithBooleanParameterTool,p as WithMultiParameterTool,c as WithParameterizedTool,Ce as __namedExportsOrder,xe as default};
