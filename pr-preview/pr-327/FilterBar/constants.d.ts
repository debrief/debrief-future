...
export declare const HISTORIC_FILTERS_LABEL = "Historic Filters";
export declare const HISTORIC_FILTERS_EMPTY = "No saved filters";
export declare const HISTORIC_FILTERS_DELETE_TOOLTIP = "Delete saved filter";
