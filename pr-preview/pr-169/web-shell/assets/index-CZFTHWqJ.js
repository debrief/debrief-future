 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(R,G){var Z=R.length;R.push(G);e:for(;0<Z;){var q=Z-1>>>1,te=R[q];if(0<a(te,G))R[q]=G,R[Z]=te,Z=q;else break e}}function r(R){return R.length===0?null:R[0]}function i(R){if(R.length===0)return null;var G=R[0],Z=R.pop();if(Z!==G){R[0]=Z;e:for(var q=0,te=R.length,Ee=te>>>1;q<Ee;){var de=2*(q+1)-1,ae=R[de],X=de+1,De=R[X];if(0>a(ae,Z))X<te&&0>a(De,ae)?(R[q]=De,R[X]=Z,q=X):(R[q]=ae,R[de]=Z,q=de);else if(X<te&&0>a(De,Z))R[q]=De,R[X]=Z,q=X;else break e}}return G}function a(R,G){var Z=R.sortIndex-G.sortIndex;return Z!==0?Z:R.id-G.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var u=Date,d=u.now();e.unstable_now=function(){return u.now()-d}}var h=[],p=[],b=1,y=null,v=3,C=!1,T=!1,S=!1,O=typeof setTimeout=="function"?setTimeout:null,x=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(R){for(var G=r(p);G!==null;){if(G.callback===null)i(p);else if(G.startTime<=R)i(p),G.sortIndex=G.expirationTime,t(h,G);else break;G=r(p)}}function E(R){if(S=!1,_(R),!T)if(r(h)!==null)T=!0,K(A);else{var G=r(p);G!==null&&$(E,G.startTime-R)}}function A(R,G){T=!1,S&&(S=!1,x(I),I=-1),C=!0;var Z=v;try{for(_(G),y=r(h);y!==null&&(!(y.expirationTime>G)||R&&!U());){var q=y.callback;if(typeof q=="function"){y.callback=null,v=y.priorityLevel;var te=q(y.expirationTime<=G);G=e.unstable_now(),typeof te=="function"?y.callback=te:y===r(h)&&i(h),_(G)}else i(h);y=r(h)}if(y!==null)var Ee=!0;else{var de=r(p);de!==null&&$(E,de.startTime-G),Ee=!1}return Ee}finally{y=null,v=Z,C=!1}}var D=!1,M=null,I=-1,j=5,H=-1;function U(){return!(e.unstable_now()-H<j)}function Q(){if(M!==null){var R=e.unstable_now();H=R;var G=!0;try{G=M(!0,R)}finally{G?ue():(D=!1,M=null)}}else D=!1}var ue;if(typeof g=="function")ue=function(){g(Q)};else if(typeof MessageChannel<"u"){var ee=new MessageChannel,be=ee.port2;ee.port1.onmessage=Q,ue=function(){be.postMessage(null)}}else ue=function(){O(Q,0)};function K(R){M=R,D||(D=!0,ue())}function $(R,G){I=O(function(){R(e.unstable_now())},G)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(R){R.callback=null},e.unstable_continueExecution=function(){T||C||(T=!0,K(A))},e.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<R?Math.floor(1e3/R):5},e.unstable_getCurrentPriorityLevel=function(){return v},e.unstable_getFirstCallbackNode=function(){return r(h)},e.unstable_next=function(R){switch(v){case 1:case 2:case 3:var G=3;break;default:G=v}var Z=v;v=G;try{return R()}finally{v=Z}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(R,G){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var Z=v;v=R;try{return G()}finally{v=Z}},e.unstable_scheduleCallback=function(R,G,Z){var q=e.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?q+Z:q):Z=q,R){case 1:var te=-1;break;case 2:te=250;break;case 5:te=1073741823;break;case 4:te=1e4;break;default:te=5e3}return te=Z+te,R={id:b++,callback:G,priorityLevel:R,startTime:Z,expirationTime:te,sortIndex:-1},Z>q?(R.sortIndex=Z,t(p,R),r(h)===null&&R===r(p)&&(S?(x(I),I=-1):S=!0,$(E,Z-q))):(R.sortIndex=te,t(h,R),T||C||(T=!0,K(A))),R},e.unstable_shouldYield=U,e.unstable_wrapCallback=function(R){var G=v;return function(){var Z=v;v=G;try{return R.apply(this,arguments)}finally{v=Z}}}})(tp);ep.exports=tp;var W_=ep.exports;/**
 * @license React
...
`,Uc=({className:e,disabled:t,open:r,value:i,options:a=[],placeholder:l="",position:u="below",onChange:d,...h})=>{const[p,b]=P.useState(void 0),[y,v]=P.useState(null),[C,T]=P.useState(r),S=P.useRef(null),O=P.useCallback(M=>{S.current&&!S.current.contains(M.target)&&(T(!1),v(null))},[S]),x=P.useCallback(M=>{if(M!==p){const I=a.find(j=>(typeof j=="string"?j:j.value)===M);b(M),d&&d(I)}T(!1)},[p]),g=P.useCallback(M=>{if(C&&M.preventDefault(),C&&M.key==="Escape")T(!1);else if(C&&M.key==="ArrowDown")v(y===null?0:Math.min(y+1,a.length-1));else if(C&&M.key==="ArrowUp")v(y===null?a.length-1:Math.max(y-1,0));else if(C&&M.key==="Enter"){const I=a[y||0],j=typeof I=="string"?I:I.value;T(!1),x(j)}},[y,C,x]),_=P.useMemo(()=>t||a.length===0,[t,a]),E=P.useMemo(()=>a.length>0?typeof a[0]=="string"?a[0]:a[0].value:"",[a]),A=P.useCallback(()=>{!t&&a.length>0&&T(!C)},[t,a,C]),D=P.useMemo(()=>{if(p&&p){const M=a.find(I=>(typeof I=="string"?I:I.value)===p);return M?typeof M=="string"?M:M.label:void 0}},[p,a]);return P.useEffect(()=>{T(!!r)},[r]),P.useEffect(()=>(C&&document.addEventListener("mousedown",O),()=>{document.removeEventListener("mousedown",O)}),[C]),P.useEffect(()=>{if(i!==void 0){const M=typeof i=="string"?i:i.value;b(M);const I=a.findIndex(j=>(typeof j=="string"?j:j.value)===i);v(I)}else b(""),v(null)},[i,a]),xe.jsxs(S1,{className:`vscrui-dropdown ${_?"disabled":""} ${e||""}`,onKeyDown:g,ref:S,...h,children:[xe.jsxs(C1,{className:`vscrui-checkbox__trigger ${C?"open":""}`,disabled:_,onClick:A,children:[xe.jsx("span",{children:D||l||E}),xe.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",xmlns:"http://www.w3.org/2000/svg",fill:"currentColor",children:xe.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M7.976 10.072l4.357-4.357.62.618L8.284 11h-.618L3 6.333l.619-.618 4.357 4.357z"})})]}),C&&!_&&xe.jsx(T1,{className:"vscrui-checkbox__listbox",position:u,children:xe.jsx("ul",{children:a.map((M,I)=>{const j=typeof M=="string"?M:M.value,H=typeof M=="string"?M:M.label,U=typeof M=="string"?!1:M.disabled;return xe.jsx("li",{onMouseEnter:()=>v(I),children:xe.jsx(P1,{className:`vscrui-checkbox__listbox__item ${y===null&&p===j||y===I?"active":""}`,"aria-selected":p===j?"true":"false",disabled:U,onClick:()=>x(j),children:H},I)},I)})})})]})};Uc.displayName="VSCRUI_Dropdown";const E1=ht.i`
  display: inline-block;
...
`,Me=({className:e,name:t,spin:r=!1,size:i=16,...a})=>{const l=P.useMemo(()=>typeof i=="number"?`${i}px`:i,[i]);return xe.jsx(E1,{className:`vscrui-icon codicon codicon-${t} ${r?"codicon-spin":""} ${e||""}`,style:{fontSize:l},...a})};Me.displayName="VSCRUI_Icon";const L1=ht.label`
  color: var(--vscode-foreground);
  font-family: var(--vscode-font-family);
  font-size: var(--vscode-font-size);
  font-weight: 400;
...
${d.join(`
`)}`}}case"bounding-box":{if(t.length===0)return{success:!1,message:"No features selected"};const l=vw(t),u=_w(l),d=Zu([l[0],l[1]],[l[2],l[1]]),h=Zu([l[0],l[1]],[l[0],l[3]]);return{success:!0,message:`Bounding box: ${(d/1e3).toFixed(2)} km × ${(h/1e3).toFixed(2)} km`,resultLayer:u}}default:return{success:!1,message:`Tool not implemented: ${e}`}}}}}const Fh=bw();function xw(){const[e,t]=P.useState("welcome"),[r,i]=P.useState(null),[a,l]=P.useState([]),[u,d]=P.useState(null),[h,p]=P.useState("full"),b=P.useMemo(()=>Dl.getItems(),[]),y=tx(),v=P.useMemo(()=>r?r.features.features:[],[r]),C=P.useMemo(()=>[...v,...a],[v,a]),T=P.useMemo(()=>v.length===0?null:hb(v),[v]),S=_g({timeExtent:T}),O=P.useMemo(()=>v.filter(I=>y.selectedIds.has(I.id)),[v,y.selectedIds]),x=P.useMemo(()=>Fh.getTools(O),[O]),g=P.useCallback(I=>{try{const j=Dl.getPlotData(I),H=Dl.getItem(I);i({itemPath:I,title:(H==null?void 0:H.properties.title)??I,features:j}),l([]),d(null),y.clear(),t("analysis")}catch(j){console.error("Failed to load plot:",j)}},[y]),_=P.useCallback(()=>{t("welcome"),i(null),l([]),d(null),y.clear()},[y]),E=P.useCallback((I,j)=>{j.ctrlKey||j.metaKey?y.toggle(I):y.select(I)},[y]),A=P.useCallback(()=>{y.clear()},[y]),D=P.useCallback(I=>{const j=Fh.runTool(I,O);d(j.message),j.resultLayer&&l(H=>[...H,j.resultLayer])},[O]),M=P.useCallback(I=>{switch(I.type){case"temporal:seek":S.setCurrentTime(I.payload.time);break;case"temporal:play":S.play();break;case"temporal:pause":S.pause();break;case"temporal:displayMode":p(I.payload.mode);break;case"tool:run":D(I.payload.toolId);break;case"layer:select":y.selectMultiple(I.payload.featureIds);break}},[S,y,D]);return e==="welcome"?w.jsxs("div",{className:"web-shell web-shell--welcome",children:[w.jsxs("header",{className:"web-shell__header",children:[w.jsx("h1",{className:"web-shell__title",children:"Debrief Web Shell"}),w.jsx("p",{className:"web-shell__subtitle",children:"STAC Catalog Browser"})]}),w.jsx("main",{className:"web-shell__main",children:w.jsx(sx,{items:b,onItemSelect:g,className:"web-shell__catalog"})})]}):w.jsxs("div",{className:"web-shell web-shell--analysis",children:[w.jsxs("header",{className:"web-shell__header",children:[w.jsx("button",{type:"button",className:"web-shell__back-button",onClick:_,"aria-label":"Back to catalog",children:"← Back to Catalog"}),w.jsx("h1",{className:"web-shell__title",children:(r==null?void 0:r.title)??"Analysis"})]}),u&&w.jsxs("div",{className:"web-shell__tool-message",role:"status",children:[w.jsx("pre",{children:u}),w.jsx("button",{type:"button",onClick:()=>d(null),"aria-label":"Dismiss message",children:"×"})]}),w.jsxs("main",{className:"web-shell__main web-shell__main--split",children:[w.jsx("aside",{className:"web-shell__sidebar",children:w.jsx(U1,{timeExtent:T,currentTime:S.currentTime,playbackState:S.playbackState,playbackSpeed:S.speed,displayMode:h,timeUiState:T?"ready":"empty",tools:x,features:C,selectedFeatureIds:Array.from(y.selectedIds),onMessage:M})}),w.jsx("section",{className:"web-shell__map-container",children:w.jsx(Eb,{features:C,selectedIds:y.selectedIds,onSelect:E,onBackgroundClick:A,currentTime:S.currentTime,displayMode:h,height:"100%",className:"web-shell__map"})})]})]})}const $g=document.getElementById("root");if(!$g)throw new Error("Root element not found");const ww=eg($g);ww.render(w.jsx(P.StrictMode,{children:w.jsx(ex,{children:w.jsx(xw,{})})}));
