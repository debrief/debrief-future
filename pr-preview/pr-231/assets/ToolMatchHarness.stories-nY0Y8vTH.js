...
}`,...(N=(A=l.parameters)==null?void 0:A.docs)==null?void 0:N.source},description:{story:`Default state with no selection.
Only "Global Statistics" tool is active (no requirements).`,...(C=(j=l.parameters)==null?void 0:j.docs)==null?void 0:C.description}}};var R,I,P,q,M;d.parameters={...d.parameters,docs:{...(R=d.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
...
}`,...(P=(I=d.parameters)==null?void 0:I.docs)==null?void 0:P.source},description:{story:"Two tracks selected - Range Calculation becomes active.",...(M=(q=d.parameters)==null?void 0:q.docs)==null?void 0:M.description}}};var W,E,F,G,K;m.parameters={...m.parameters,docs:{...(W=m.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
...
}`,...(F=(E=m.parameters)==null?void 0:E.docs)==null?void 0:F.source},description:{story:"One track and one point selected - Bearing to Point active.",...(K=(G=m.parameters)==null?void 0:G.docs)==null?void 0:K.description}}};var H,O,$,L,D;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
...
}`,...($=(O=p.parameters)==null?void 0:O.docs)==null?void 0:$.source},description:{story:"Show inactive tools toggle enabled.",...(D=(L=p.parameters)==null?void 0:L.docs)==null?void 0:D.description}}};var B,V,z,Z,U;h.parameters={...h.parameters,docs:{...(B=h.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
...
}`,...(z=(V=h.parameters)==null?void 0:V.docs)==null?void 0:z.source},description:{story:"All tracks selected - Track Summary active.",...(U=(Z=h.parameters)==null?void 0:Z.docs)==null?void 0:U.description}}};var J,Q,X,Y,ee;u.parameters={...u.parameters,docs:{...(J=u.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: {
...
}`,...(X=(Q=u.parameters)==null?void 0:Q.docs)==null?void 0:X.source},description:{story:"Many features selected - demonstrates complex matching.",...(ee=(Y=u.parameters)==null?void 0:Y.docs)==null?void 0:ee.description}}};var te,ae,se,oe,re;v.parameters={...v.parameters,docs:{...(te=v.parameters)==null?void 0:te.docs,source:{originalSource:`{
  args: {
...
}`,...(ce=(ie=g.parameters)==null?void 0:ie.docs)==null?void 0:ce.source},description:{story:"Dark theme variant.",...(de=(le=g.parameters)==null?void 0:le.docs)==null?void 0:de.description}}};const We=["Default","TwoTracksSelected","TrackAndPoint","ShowInactive","AllTracksSelected","ComplexSelection","RectangleSelected","DarkTheme"];export{h as AllTracksSelected,u as ComplexSelection,g as DarkTheme,l as Default,v as RectangleSelected,p as ShowInactive,m as TrackAndPoint,d as TwoTracksSelected,We as __namedExportsOrder,Me as default};
