...
}`,...(Ue=(Le=u.parameters)==null?void 0:Le.docs)==null?void 0:Ue.source},description:{story:"The empty rail with the primary Capture Scene affordance — the entry\npoint that replaces the legacy `Press Ctrl/Cmd+Alt+C on the map…`\nempty-state copy from #216.",...(Je=(je=u.parameters)==null?void 0:je.docs)==null?void 0:Je.description}}};var $e,Ge,Ye,ze,Ke;m.parameters={...m.parameters,docs:{...($e=m.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  args: {
    scenes: [],
    activeStoryboardName: null,
    captureInFlight: false,
