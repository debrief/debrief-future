/**
 * StacBrowser component exports (#132).
 */
...
export { createBrowserRegistry } from './createBrowserRegistry';
export { BROWSER_PANEL_LIST, BROWSER_PANEL_MAP, BROWSER_PANEL_TIMELINE, BROWSER_LAYOUT_CONFIG, } from './browserLayout';
