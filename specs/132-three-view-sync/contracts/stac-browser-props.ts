/**
 * Contract: StacBrowser component props.
 * Feature: 132-three-view-sync
 *
 * The StacBrowser is the top-level orchestrator that composes
 * FilterBar, ExerciseListView, MapView, and TimelineView
 * with synchronized filter state.
 */

import type { StacBrowserItem, VesselTaxonomyNode } from '../../../shared/components/src/filter-engine/types';
