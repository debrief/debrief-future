...
author: Ian
reading_time: 5
tags: [shipped, nl-search, nl-cql2, filter-engine, llm, tracer-bullet]
...
→ [See the implementation](https://github.com/debrief/debrief-future/pull/188)
→ [Harness report](https://github.com/debrief/debrief-future/blob/main/specs/188-nl-cql2-prompt/evidence/harness-report.txt)
→ [Usage example](https://github.com/debrief/debrief-future/blob/main/specs/188-nl-cql2-prompt/evidence/usage-example.md)
