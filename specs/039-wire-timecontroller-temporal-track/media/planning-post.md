...
- **Multi-track interaction**: When scrubbing over tracks with different start/end times, should out-of-range tracks disappear, freeze at their endpoint, or fade out?
- **Trail rendering limits**: For very long tracks (100k+ points), should we sample points or cap the trail length?
- **Keyboard scrubbing**: Should arrow keys nudge time forward/backward, or is the mouse slider sufficient?

Drop feedback in the discussion thread — we're building for DSTL scientists and defence practitioners.
