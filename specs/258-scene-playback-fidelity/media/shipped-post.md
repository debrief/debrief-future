---
title: "Building Storyboard Scene Playback Fidelity"
date: 2026-05-12
...
| Files changed | ~15 (schemas, components, both hosts, tests) |
...
- Schema-extension `_polygon_source` opens the door for `'manual'`-source scenes — author-drawn rectangles that don't track a captured viewport. That's the next storyboarding feature on the horizon.
...
- Spec: `specs/258-scene-playback-fidelity/spec.md`
- Plan: `specs/258-scene-playback-fidelity/plan.md`
- Round-trip evidence: `specs/258-scene-playback-fidelity/evidence/round-trip-evidence.md`
- Usage example: `specs/258-scene-playback-fidelity/evidence/usage-example.md`
- Decision references: Constitution Article II.1 (single source of truth), Article III.2 (source preservation), Article IV.1 (services never touch UI)
