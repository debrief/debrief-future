---
layout: future-post
title: "Planning: Reorganizing STAC Stores to Per-Item Folders"
date: 2026-02-03
track: [momentum]
author: Ian
reading_time: 5
tags: [tracer-bullet, stac, storage, infrastructure]
excerpt: "Moving from flat to hierarchical storage to support provenance and asset management"
---
...
If you use Debrief and have local plot stores, does the idea of per-item folders feel natural, or does flat collection feel more convenient? Are there file patterns you'd expect to see in the `assets/` folder that we haven't thought about?

If you're building extensions or custom analysis, does this hierarchy make it easier to reason about where things are? Or does it add friction?

And for the slightly more technical: we're thinking of exposing the migration via a JSON-RPC CLI command. Does that feel like the right integration point, or should migration be something you trigger from VS Code itself?

→ [Discuss on GitHub](https://github.com/debrief/debrief-future/discussions)
