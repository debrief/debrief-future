...
→ [See the spec](/home/user/debrief-future/specs/095-polygon-polyline-drawing/spec.md)
→ [View test results](/home/user/debrief-future/specs/095-polygon-polyline-drawing/media/test-output.txt)
