...
|:-:|:-:|
| ![Transport idle](../evidence/screenshots/transport-bar-idle.png) | ![Transport replay](../evidence/screenshots/transport-bar-end-of-storyboard.png) |

| ModeToggle — Minimal | ModeToggle — Present (hover-revealed) |
|:-:|:-:|
| ![Mode toggle minimal](../evidence/screenshots/mode-toggle-minimal.png) | ![Mode toggle present](../evidence/screenshots/mode-toggle-present.png) |
...
| light | dark | vscode |
|:-:|:-:|:-:|
| ![MapView briefing props (light)](../evidence/screenshots/mapview-briefing-props-light.png) | ![MapView briefing props (dark)](../evidence/screenshots/mapview-briefing-props-dark.png) | ![MapView briefing props (vscode)](../evidence/screenshots/mapview-briefing-props-vscode.png) |
...
![Interaction](../evidence/screenshots/interaction.gif)
