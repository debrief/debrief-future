# Specification Quality Checklist: Drawing UX Guidance and STAC Persistence
...
- UI Feature Validation items apply — the spec contains a "User Interface Flow" section
