# Specification Quality Checklist: Context-Sensitive Tool Offering
...
- Technical references to MCP protocol (`list_tools`, `execute_tool`) are appropriate as they describe external interfaces, not implementation choices
