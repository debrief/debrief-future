---
layout: future-post
title: "Planning: Context-Sensitive Tool Offering"
date: 2026-01-24
track: [momentum]
author: Ian
reading_time: 3
tags: [tracer-bullet, vscode-extension, tools]
excerpt: "Matching analysis tools to feature selections — the bridge between data and insight"
---
...
The matching algorithm rejects selections with "extra" feature kinds — if a tool only accepts tracks, and you've also selected a point, the tool won't appear. Is this the right behaviour? Alternative: show the tool but warn about ignored features.

For inactive tool explanations, we show the first unmet requirement. Should we instead show all unmet requirements, even if it's verbose?

→ [See the specification](https://github.com/debrief/debrief-future/blob/main/specs/027-context-tool-offering/spec.md)
