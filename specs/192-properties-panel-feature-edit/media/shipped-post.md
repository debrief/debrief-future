...
| | |
|---|---|
| ![Feature mode (VS Code theme)](../evidence/screenshots/properties-feature-vscode.png) | ![Sub-feature mode — track point](../evidence/screenshots/properties-subfeature-track-vscode.png) |
| Feature mode | Sub-feature mode (track point) |
| ![Sub-feature mode — polygon vertex](../evidence/screenshots/properties-subfeature-polygon-vscode.png) | ![Multi-select summary](../evidence/screenshots/properties-multiselect-vscode.png) |
| Sub-feature mode (polygon ring vertex) — same form, different address | Multi-select summary |
| ![Read-only banner](../evidence/screenshots/properties-readonly-vscode.png) | ![Read-only in the live web-shell](../evidence/screenshots/workflow-readonly.png) |
...
![Plot mode](../evidence/screenshots/workflow-mode-swap-1-plot.png)
![Feature mode](../evidence/screenshots/workflow-mode-swap-2-feature.png)
![Sub-feature mode](../evidence/screenshots/workflow-mode-swap-3-subfeature.png)
![Multi-select mode](../evidence/screenshots/workflow-mode-swap-4-multi.png)
