...
- **Interaction GIF (T105):** the headline flow is captured as the static `roundtrip-host-a.png` / `roundtrip-host-b.png` pair; an animated GIF was not generated (ffmpeg not available in the capture environment).
