---
layout: future-post
title: "Building a self-describing plot: retiring the session sidecar"
date: 2026-05-28
track: [credibility]
author: Ian
reading_time: 9
feature: 261-session-state-systemstate
tags: [tracer-bullet, schemas, linkml, session-state, architecture, tech-debt, shipped]
...
![Host B after a features-only transfer: the same viewport, the playhead restored to 09:30:00, and track-hms-defender selected, with the title bar reading transferred/plot.geojson.](../evidence/screenshots/roundtrip-host-b.png)
...
![Host A: a feature has been hidden from the layers panel.](../evidence/screenshots/visibility-host-a.png)

*Host A: a feature hidden.*

![Host B: after a features-only reopen, the same feature is still hidden — its visible flag rode along inside the FeatureCollection.](../evidence/screenshots/visibility-host-b.png)
...
![Strict-on-import error banner naming the offending SystemState feature id after a self-contradictory state was loaded.](../evidence/screenshots/strict-import-error.png)
