---
layout: future-post
title: "Planning: Analysis Log Panel — Rich Card UX"
date: 2026-04-02
track: [momentum]
author: Ian
reading_time: 3
tags: [log-panel, provenance, ux, shared-components]
excerpt: "Transforming raw provenance records into analyst-readable cards with typed chips and tool icons"
---
...
- Does the 4-tab model (Timeline, By Feature, Compact, Detailed) make sense as a single selector, or would analysts prefer the current two-axis approach (layout + detail level)?

- Are there parameter types beyond colour, number, boolean, range, and enum that should get their own chip rendering? We can extend the inference chain later, but it helps to know what analysts encounter most.

- The non-default parameter marker is a small red dot. Is that sufficient visual weight, or would analysts prefer something more prominent?
