---
layout: future-post
title: "Planning: Focused Analysis Environment"
date: 2026-01-23
track: [momentum]
author: Ian
reading_time: 2
tags: [vscode-extension, ux, tracer-bullet]
excerpt: "Removing VS Code clutter so analysts can focus on tracks, not toolbars"
---
...
- Is there a default activity you'd expect to remain visible for analysis work?
- Should the extension show a notification on first run explaining what changed?
- Any concerns about modifying VS Code internal settings?
