---
layout: future-post
title: "Planning: Drawing Toolbar with Shape Palette"
date: 2026-02-13
track: [momentum]
author: Ian
reading_time: 3
tags: [tracer-bullet, e05-shape-drawing, geoman, session-state]
excerpt: "Replacing the proof-of-concept draw button with a proper shape palette -- four geometry types behind a single '+' click."
---
...
The single-shot behavior (draw one shape, return to default) vs. persistent drawing mode (keep drawing until you explicitly cancel) -- which fits your workflow better? We went with single-shot as the safer default, but persistent mode could be added for power users.

The dropdown positions to the right of the '+' button by default, falling back to below or above in narrow panels. If you use Debrief in a cramped side panel, does this directional logic match your expectations?
