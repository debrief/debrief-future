---
layout: future-post
title: "Building Prefix-Aware STAC Typing"
date: 2026-06-02
track: [credibility]
author: Ian
reading_time: 5
tags: [tracer-bullet, stac, schema, typescript, linkml]
excerpt: "Schema-driven typing closes the gap between LinkML definitions and the debrief: keys writers actually use — typos now fail at build time."
---
