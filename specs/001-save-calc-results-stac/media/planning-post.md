---
layout: future-post
title: "Planning: Save Analysis Results to STAC"
date: 2026-01-29
track: [momentum]
author: Ian
reading_time: 3
tags: [tracer-bullet, stac, provenance, debrief-calc]
excerpt: "Planning how calc tool results get persisted to the STAC catalog with full provenance chains."
---
...
- Should saved results be visually distinguished in the catalog listing, or is the `debrief:kind` property enough for programmatic filtering?
- When a source item has been deleted, the `derived_from` links become dangling. Is that acceptable, or should we warn the user?
- Should we support bulk-saving all unsaved results at once, or is per-result saving sufficient for now?
