---
title: "Planning: Epic Support for Large Feature Breakdown"
date: 2026-01-23
category: planning
...
- **Item sizing**: We're targeting items completable in 1-3 days. Is this the right granularity for your workflow?
- **Epic statuses**: Currently proposed → active → complete. Should we add more states?
- **Breakdown guidelines**: Our prompt emphasizes vertical slices over horizontal layers. Would you sequence differently?

The first epic to use this workflow will be our Storyboarding Briefings feature—a substantial capability that needs careful decomposition before implementation begins.

---

*This is a planning post. Implementation will follow after the design phase completes.*
