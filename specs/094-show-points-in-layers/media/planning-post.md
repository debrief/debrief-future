---
layout: future-post
title: "Planning: Show Child Points in Layers Panel"
date: 2026-02-13
track: [momentum]
author: Ian
reading_time: 4
tags: [tracer-bullet, layers-panel, selection]
excerpt: "Adding expand/collapse to the Layers panel so analysts can browse and select individual points within tracks."
---
...
- **Naming for multi-feature children.** We've settled on "Point 1, Point 2" for multi-point results and "Polygon 1, Polygon 2" for multi-polygon results. Does this make sense for analysis workflows?

- **Expansion keyboard shortcuts.** We're planning standard arrow-key navigation (right expands, left collapses). Should we add "expand all" or "collapse all" shortcuts, or is that over-engineering for a first pass?

- **Metadata display priorities.** When a position has timestamp, course, speed, and depth, what should show inline in the parent row vs. the expanded child? Currently thinking: timestamp and feature count in parent, full metadata in expanded children.
