---
layout: future-post
title: "Planning: Thin Wrapper for VS Code Map"
date: 2026-02-04
track: [momentum]
author: Ian
reading_time: 3
tags: [tracer-bullet, vscode-extension, architecture]
excerpt: "Moving map logic from VS Code to shared components for better testability"
---
...
- Are there map features in the VS Code panel that you use regularly? We want to make sure we don't miss anything in the shared component.

- How do you currently debug map rendering issues? Would Storybook-based development help your workflow?

- Any concerns about the React wrapper approach vs vanilla TypeScript?

→ [See the specification](https://github.com/debrief/debrief-future/tree/048-refactor-vscode-map-wrapper/specs/048-refactor-vscode-map-wrapper/spec.md)
