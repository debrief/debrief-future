...
→ [See the spec](C:/git/debrief-future/specs/038-context-tool-vscode/spec.md)
→ [View test summary](C:/git/debrief-future/specs/038-context-tool-vscode/evidence/test-summary.md)
