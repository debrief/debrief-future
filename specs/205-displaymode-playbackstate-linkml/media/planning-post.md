---
layout: future-post
title: "Planning: Schema-Rooted DisplayMode and PlaybackState Enums"
date: 2026-04-21
track: [momentum]
author: Ian
reading_time: 4
tags: [tracer-bullet, schema-integrity, linkml, tech-debt]
excerpt: "Collapsing four hand-typed TypeScript enums and eight translator sites into a single schema-rooted pair generated from LinkML."
---
...
This is the third LinkML consolidation in the #203 / #204 / #205 run, all feeding the broader audit in Epic E11 (#206). The interesting question at this point is whether we've found all the drift vectors worth collapsing — or whether there are hand-typed / schema-rooted divergences elsewhere in the tree that contributors have run into and worked around.

If you've noticed a type that ought to be generated but isn't, or a translator helper that looks suspiciously like the `toComponentMode` / `toStoreMode` pair this feature is deleting, pointers to the audit are the most useful thing you can add.

→ [See the spec](https://github.com/debrief/debrief-future/tree/main/specs/205-displaymode-playbackstate-linkml)
→ [Epic E11: Audit non-LinkML type declarations (#206)](https://github.com/debrief/debrief-future/issues/206)
