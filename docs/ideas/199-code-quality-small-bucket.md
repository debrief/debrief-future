...
## Dependencies
None — independent of all other code-quality follow-up items (#200 – #206, E11, E12).

## Parallelisation
Fully parallel with #200, #201, #202, #206, and the LinkML-layer items #203 / #204 / #205. Different file footprints; merge-conflict risk is minimal.
