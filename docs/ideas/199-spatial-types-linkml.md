...
## Parallelisation
This is one of three LinkML-layer items (#199, #200, #201) that all edit `shared/schemas/src/*.yaml` and regenerate. To parallelise safely:
...
Fully parallel with #195, #196, #197, #198, #202 (none touch LinkML).
