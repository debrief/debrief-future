...
2. For each, classify:
   ...
   - **Boundary / parse-time loose type** (e.g. `RawGeoJSONFeature`, raw JSON parsing) — ideally LinkML-rooted per #200, otherwise justified exception
...
- New backlog items exist for every "promote to LinkML" and "drift candidate" finding not already covered by #199 – #201 or E11
