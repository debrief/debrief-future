...
### ADR-028: Persistence-host abstraction — IndexedDB adaptor + Article IV.4 amendment (#236, 2026-05-01)

**Status:** Accepted. Implemented in feature `236-web-shell-stac-writes`.

**Context.**

Pre-ADR-028, the constitution's Article IV.2 ("Frontends never persist") was
