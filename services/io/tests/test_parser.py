...
class TestParse:
    ...
    def test_parse_rep_file(self, boat2_rep: Path) -> None:
    ...
    def test_parse_string_path(self, boat2_rep: Path) -> None:
        """Accept string path."""
...
class TestParseRep:
    ...
    def test_parse_rep_basic(self, boat2_rep: Path) -> None:
    ...
    def test_parse_rep_string_path(self, boat2_rep: Path) -> None:
        """Accept string path."""
        result = parse_rep(str(boat2_rep))
        assert len(result.features) >= 1

    def test_parse_rep_file_not_found(self) -> None:
        """Raise FileNotFoundError for missing file."""
        with pytest.raises(FileNotFoundError):
            parse_rep("/nonexistent/file.rep")

    def test_parse_rep_returns_correct_handler(self, boat2_rep: Path) -> None:
...
class TestParseIntegration:
    ...
    def test_parse_boat1_and_boat2(self, boat1_rep: Path, boat2_rep: Path) -> None:
    ...
    def test_parsed_features_have_required_fields(self, boat2_rep: Path) -> None:
    ...
    def test_parse_result_metadata(self, boat2_rep: Path) -> None:
