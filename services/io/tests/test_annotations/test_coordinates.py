...
class TestParseDMS:
    ...
    def test_parse_latitude(self) -> None:
    ...
    def test_parse_longitude(self) -> None:
    ...
    def test_parse_from_longer_string(self) -> None:
...
class TestParseLatLon:
    ...
    def test_from_shapes_rep_format(self) -> None:
...
class TestParseMultipleLatLon:
    ...
    def test_parse_two_pairs(self) -> None:
    ...
    def test_parse_three_pairs(self) -> None:
    ...
    def test_odd_coordinates_dropped(self) -> None:
