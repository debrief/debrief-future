...
class TestValidatePlatformIds:
    ...
    def test_all_registered_no_warnings(self, registry) -> None:
    ...
    def test_unregistered_platform_produces_warning(self, registry) -> None:
    ...
    def test_empty_platform_id_skipped(self, registry) -> None:
    ...
    def test_whitespace_platform_id_skipped(self, registry) -> None:
    ...
    def test_duplicate_ids_produce_one_warning(self, registry) -> None:
    ...
    def test_case_sensitive_lookup(self, registry) -> None:
    ...
    def test_no_platform_id_property_skipped(self, registry) -> None:
    ...
    def test_mixed_registered_and_unregistered(self, registry) -> None:
    ...
    def test_warnings_sorted_by_platform_id(self, registry) -> None:
