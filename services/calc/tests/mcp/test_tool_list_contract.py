...
class TestToolListContract:
    ...
    def test_to_mcp_tool_has_required_fields(self):
    ...
    def test_annotations_have_required_debrief_keys(self):
    ...
    def test_selection_requirements_are_list_of_dicts(self):
    ...
    def test_input_schema_has_features_and_params(self):
