...
- TypeScript 5.x (state server + VS Code extension), Python 3.11+ (MCP client library) + Zustand ^5.0.0, Zundo ^2.0.0, Express ^4.18.0, @modelcontextprotocol/sdk ^1.0.0, better-sse ^1.0.0, Zod ^3.22.0, Vitest ^1.0.0 (024-document-session-state)
