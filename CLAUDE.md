...
- TypeScript 5.x + React 18+, react-leaflet v4+ (map), @tanstack/react-virtual (lists), HTML5 Canvas (timeline), CSS Custom Properties (theming), Storybook 10.x (component preview) (001-shared-react-components)
- N/A (pure display components — no persistence) (001-shared-react-components)

## Recent Changes
- 001-shared-react-components: Added TypeScript 5.x + React 18+, react-leaflet v4+, @tanstack/react-virtual, HTML5 Canvas, CSS Custom Properties, Storybook 10.x
