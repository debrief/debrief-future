...
- Python 3.11 (LinkML schemas, Pydantic models), TypeScript 5.x (generated types) + LinkML >= 1.7.0, Pydantic v2, gen-pydantic, gen-json-schema, gen-typescript (081-add-multi-feature-styling)
