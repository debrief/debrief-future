...
- TypeScript 5.x (VS Code extension webview) + Leaflet ^1.9.4 (already in project), VS Code extension API, esbuild (041-stac-catalog-overview-panel)
- Local filesystem STAC catalogs (read-only) (041-stac-catalog-overview-panel)
