...
- Python 3.11+ (service library), TypeScript 5.x (app library) (003-debrief-config)
- JSON file in XDG config directory (`~/.config/debrief/config.json` on Linux) (003-debrief-config)
